    ...
    <>
      <div id="Presentation">
        ...
        <article>
          ...
          <p>
            De plus, en HTML, on peut être amené à utiliser du kebab-case, en JS le kebab-case est interdit. Il faut
          ...
          <p className={ma_class}>
            Mais ils peuvent également interpoler du JS, grâce aux accolades. : className={"{"}ma_class{"}"}{" "}
          </p>
        ...
        <article>
          ...
          <ul>
            <li>
              Style : <span style={{ color: "red" }}>mon span en style</span>
            </li>
          ...
          <hr />
          <p>
            Les images utilisées en CSS doivent être rangées dans src, et le chemin passé se fait depuis le fichier css.
          </p>
