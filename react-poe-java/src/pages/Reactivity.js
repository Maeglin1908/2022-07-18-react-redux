  ...
  return (
    <>
      ...
      <article>
        ...
        <p>
          En React, on gère les éléments comme en HTML : avec les attributs d'évenement (onClick, onSubmit, onMouseOver
          ... )
        </p>
        <p>
          On passe la fonction à appeler entre accolades, et sans parenthèses : React fournit automatiquement le
          paramètre Event à la fonction appelée.
        </p>
        <p>
      ...
      <article>
        ...
        <p>La modification de compteur se fait bien, mais React ne met pas à jour le DOM de manière dynamique.</p>
      </article>
      <article>
        <h2>Hook d'état</h2>
        ...
        <p>Pour indiquer à Réact d'écouter des valeurs pour mettre à jour le DOM, il faut utiliser les Hooks.</p>
        ...
        <p>
          Dans un composant, on peut déclarer autant de hook d'état qu'on le souhaite, et ils peuvent prendre tout type
          de valeur.
        </p>
